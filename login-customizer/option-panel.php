...
<div class="wrap">
    ...
    <p><?php _e('If you find any issues or if you want to contribute, then please free to drop me a mail at', 'login-customizer'); ?> <a href="http://www.hardeepasrani.com/contact" target="_blank" rel="nofollow"><?php _e('this link', 'login-customizer'); ?></a>.</p>
    <p><?php _e('If you are kind (and/or rich) then please consider making a donation for this free plugin at', 'login-customizer'); ?> <a href="http://www.hardeepasrani.com/donate" target="_blank" rel="nofollow"><?php _e('this link', 'login-customizer'); ?></a>.</p>
    <p><?php _e('Thanks for using this plugin. Don not forget to leave a review.', 'login-customizer'); ?></p>
    <p> <a href="http://www.hardeepasrani.com/" target="_blank" rel="nofollow"><?php _e('Hardeep Asrani :)', 'login-customizer'); ?></a>.</p>
</div>
<?php
}
?>